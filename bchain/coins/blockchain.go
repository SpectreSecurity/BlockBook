...
import (
	...
	"blockbook/bchain/coins/gamefrag"
	"blockbook/bchain/coins/seed2need"
	"blockbook/bchain/coins/nebula"
...
func init() {
	...
	BlockChainFactories["GameFrag"] = gamefrag.NewPivXRPC
	BlockChainFactories["Seed2Need"] = seed2need.NewPivXRPC
	BlockChainFactories["Nebula"] = nebula.NewPivXRPC
