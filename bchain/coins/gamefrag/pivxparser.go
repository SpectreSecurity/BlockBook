...
const (
    // Net Magics
    MainnetMagic wire.BitcoinNet = 0x8c93eca1
    TestnetMagic wire.BitcoinNet = 0xa1ee8ec0
    ...
    // Staking Addresses
    STAKING_ADDR_MAIN = 45
    STAKING_ADDR_TEST = 41
...
func init() {
    ...
    MainNetParams.PrivateKeyID = []byte{61}
    ...
    TestNetParams.PrivateKeyID = []byte{51}
}
