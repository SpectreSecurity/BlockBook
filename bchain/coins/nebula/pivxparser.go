...
const (
    // Net Magics
    MainnetMagic wire.BitcoinNet = 0xdabadfe7
    TestnetMagic wire.BitcoinNet = 0xe0b9a6d4
    ...
    // Staking Addresses
    STAKING_ADDR_MAIN = 80
    STAKING_ADDR_TEST = 58
...
func init() {
    ...
    MainNetParams.PubKeyHashAddrID = []byte{61} // starting with 'D'
    MainNetParams.ScriptHashAddrID = []byte{57}
    MainNetParams.PrivateKeyID = []byte{75}

    // PIVX testnet Address encoding magics
    TestNetParams = chaincfg.TestNet3Params
    TestNetParams.Net = TestnetMagic
    TestNetParams.PubKeyHashAddrID = []byte{66} // starting with 'x' or 'y'
    TestNetParams.ScriptHashAddrID = []byte{37}
    TestNetParams.PrivateKeyID = []byte{71}
}
