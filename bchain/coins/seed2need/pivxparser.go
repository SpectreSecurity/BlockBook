...
const (
    // Net Magics
    MainnetMagic wire.BitcoinNet = 0xee8bd39a
    TestnetMagic wire.BitcoinNet = 0xdac69abb
    ...
    // Staking Addresses
    STAKING_ADDR_MAIN = 38
    STAKING_ADDR_TEST = 53
...
func init() {
    ...
    MainNetParams.PubKeyHashAddrID = []byte{35} // starting with 'D'
    ...
    TestNetParams.PubKeyHashAddrID = []byte{58} // starting with 'x' or 'y'
    TestNetParams.ScriptHashAddrID = []byte{48}
    TestNetParams.PrivateKeyID = []byte{61}
}
